...
class Fixed extends StatefulWidget{
  @override
  State<StatefulWidget> createState() => _FixedState();//this is state create :

}



class _FixedState extends State <Fixed> {//this is the state we created
  String result = "";
...
_calc(){
  ...
  double total = (rate / 100)  * amt * (tenure / 365);
  double govttax = 0.1 * total;
  double payable = total - govttax;
  String summary = "Total:N " + total.toStringAsFixed(2) + '\n'+ '\n' + "Payable:N " + payable.toStringAsFixed(2) + '\n'+ '\n' + "Tax:N " + govttax.toStringAsFixed(2) ;
  return summary;
}
